...
const CollapsableFoodGroupContent = ({ foodGroup, show, openModal }) => {
...
export const FoodGroup = ({ foodGroup, foodGroupDisplayName, headingSize, openModal }) => {
    ...
    return (
        <Box mb={0}>
            ...
            <CollapsableFoodGroupContent foodGroup={foodGroup} show={show} openModal={openModal} />
